...
<div style='background-color: #FFFFFF; padding: 10px; border-radius: 5px; margin-bottom: 10px; display: flex'>
    <div style="width: 20%; display: flex; justify-content: center">
        <img src="https://cdn.icon-icons.com/icons2/1369/PNG/512/-person_90382.png" style="max-height: 50px; max-width: 50px; border-radius: 50%;">
    </div>
    <div style="width: 80%;">
        $MSG
    </div>
...
<div style='background-color: #FFFFFF; padding: 10px; border-radius: 5px; margin-bottom: 10px; display: flex'>
    ...
    <div style="width: 20%; margin-left: auto; display: flex; justify-content: center;">
        <img src="https://cdn.icon-icons.com/icons2/1369/PNG/512/-person_90382.png" style="max-width: 50px; max-height: 50px; float: right; border-radius: 50%;">
    </div>    
</div>
'''
